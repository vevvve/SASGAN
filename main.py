...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_name', help='input image name for training',default="Images/Generation/shale40.tif")#
    parser.add_argument('--highres', default="Images/Generation/shale80.tif")
