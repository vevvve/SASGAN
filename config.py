...
def get_arguments():
    ...
    parser.add_argument('--n_residual_blocks', type=int, default=8)#4
    ...
    parser.add_argument('--max_size', type=int,help='image minimal size at the coarser scale', default=80)
